...
const Education = () => {
  return (
    <div className="py-10 transition-all duration-700 ease-in-out">
      <div className="relative">
        ...
        <div className="absolute left-3 top-7 h-44 w-[2px] bg-[#f3749a] lg:h-52"></div>
      </div>
      <div className="ml-10 mt-12">
        <h4 className="mb-5 w-[285px] rounded-md bg-[#FF014F] px-3 font-poppinsSemibold text-white esm:w-[270px] esm:text-sm">
          January 2020 - December 2024
        </h4>
        <p className="text-justify font-poppinsReg leading-relaxed text-slate-700 esm:text-[10px] md:text-[14px] lg:text-lg">
